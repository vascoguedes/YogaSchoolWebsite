...
class Classes extends React.Component {
  ...
  render() {
    ...
    <>
      ...
      <ClassInfo id="3" imageside={0} image={logo3} title='YOGA PARA INICIANTES' description={['Uma prática de yoga para quem está a iniciar este caminho maravilhoso. Aulas leves com posturas fáceis de executar, onde o objetivo é ficar a conhecer e entender o yoga.', 'Trabalhamos não só a parte física, como também a mental e espiritual, onde o corpo, alma e mente se unem e tudo flui através da nossa prática. <br/> Se nunca fizeste yoga, ou não tens muita experiência, esta é uma ótima aula para começares a tua jornada!']} duration={"Duração 1h"} price={"Preço 10€"}/>
      <ClassInfo id="4" imageside={1} image={logo4} title='YOGA RESTAURATIVO' description={['Nos dias de hoje, cheios de emoção e stress, desaprendemos a descansar verdadeiramente. O Yoga Restaurativo vem trazer-nos essa pausa, esse restauro, essa conexão com nós mesmos que às vezes nos parece perdida.', 'São aulas de puro relaxamento, sem precisar de esforço algum, auxiliadas por mantas, almofadas e toalhas, para um conforto total.']} duration={"Duração 30min"} price={"Preço 5€"}/>
      <Footer />
    </>
  );
  }
